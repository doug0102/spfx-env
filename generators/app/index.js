...
`;
  ...
  _patchGitignore() {
    ...
    const additions = [];
    if (!content.includes('config/*.bak.json'))       additions.push('config/*.bak.json');
    if (!content.includes('.yo-rc.bak.json'))          additions.push('.yo-rc.bak.json');
    if (!content.includes('src/**/*.bak.json'))        additions.push('src/**/*.bak.json');
    if (!content.includes('src/types/env.d.ts'))       additions.push('src/types/env.d.ts');
    if (!content.includes('src/config/envConfig.ts'))  additions.push('src/config/envConfig.ts');
